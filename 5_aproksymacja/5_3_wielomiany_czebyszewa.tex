...
\begin{frame}{Symetria}
    ...
    \begin{figure}
		\includegraphics[height=0.75\textheight]{img/symetria.jpg}
	\end{figure}
\end{frame}
%%%%%%%%%%%%%%%%%%%
...
\begin{frame}
	...
	\end{tabular}	
    \begin{figure}
		\includegraphics[height=0.7\textheight]{img/dowod.jpg}
	\end{figure}
\end{frame}
%%%%%%%%%%%%%%%%%%%
\begin{frame}
...
\begin{frame}
	\begin{figure}
		\includegraphics[height=0.8\textheight]{img/czebyszew.jpg}
	\end{figure}
\end{frame}
%%%%%%%%%%%%%%%%%%%
...
\begin{frame}
	\begin{figure}
		\includegraphics[height=0.8\textheight]{img/interpolacja.jpg}
	\end{figure}
\end{frame}
