...
\subsection{Metoda simpleksów}
  ...
  \begin{frame}{Simplex - wprowadzenie}
 	...
 	J.A.Nelder, R.Mead: \emph{A simplex method for function minimization}
 	\\Comput. J. 7 (1965) 308. % ???
    ...
    \begin{block}{}
      \begin{itemize}
 	      ...
 	      \item[--] ale łatwo przy okazji :
 	  	  \begin{displaymath}
 	   	  	\frac{\partial (F)}{\partial (x)} \bigg\vert_{x_0} \approx \frac{F(x_0+d) - 2F(x_0) + F(x_0-d)}{d^2}
 	      \end{displaymath}
  ...
  \begin{frame}{Metoda sprzężonych kierunków cd.}
    ...
    \\ze względu na \emph{hessjan} $G$
 	\begin{block}{Twierdzenie}
 	   (R. Fletcher, C.M. Reeves: \emph{Function minimalization by conjugate gradients}, Comput. J. 7 (1964) 149):
 	   \smallskip
